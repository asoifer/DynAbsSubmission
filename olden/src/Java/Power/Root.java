...
final class Root 
{
  ...
  void nextIter(boolean verbose) 
  {
	...
	double d_theta_R = -(theta_R - D.P/10000.0) / (1 - (map_P[i+1] - map_P[i]) / (PER_INDEX_R * 10000.0));
	...
	if (i>35) 
		i=35;
    double d_theta_I = -(theta_I - D.Q/10000.0) / (1 - (map_Q[i+1] - map_Q[i]) / (PER_INDEX_I * 10000.0));
