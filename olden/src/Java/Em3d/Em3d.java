...
public class Em3d 
{
  ...
  public static final void main(String args[])
  {
    ...
    double slicingVariable1 = graph.eNodes.value;
    double[] slicingVariable2 = graph.eNodes.coeffs;
    double slicingVariable3 = graph.eNodes.coeffs[0];
    int slicingVariable4 = graph.eNodes.fromCount;
    int slicingVariable5 = graph.eNodes.fromLength;
