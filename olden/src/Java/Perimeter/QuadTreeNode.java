...
abstract class QuadTreeNode
{
   ...
   * @return the node representing the north west quadrant.
   **/
  final QuadTreeNode getNorthWest() 
  { 
	return nw; 
  }
  /**
   ...
   * @return the node representing the north east quadrant.
   **/
  final QuadTreeNode getNorthEast() 
  { 
    return ne; 
  }
  /**
   ...
   * @return the node representing the south west quadrant.
   **/
  final QuadTreeNode getSouthWest() 
  { 
	return sw; 
  }
  /**
   ...
   * @return the node representing the south east quadrant.
   **/
  final QuadTreeNode getSouthEast() 
  { 
    return se; 
  }
   ...
   **/
  static QuadTreeNode createTree(int size, int center_x, int center_y, QuadTreeNode parent, Quadrant quadrant, int level)
  {
    QuadTreeNode node;
