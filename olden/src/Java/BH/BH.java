...
public class BH 
{
  ...
  public static final void main(String args[])
  {
    ...
    if (printResults) 
	{
      ...
      while(current != null) 
	  {
		System.out.println("body " + j++ + " -- " + current.pos);
    ...
    MathVector slicingVariable1 = root.bodyTab.pos;
    double slicingVariable2 = root.bodyTab.pos.data[0];
    MathVector slicingVariable3 = root.bodyTab.vel;
    double slicingVariable4 = root.bodyTab.vel.data[0];
    MathVector slicingVariable5 = root.bodyTab.acc;
    double slicingVariable6 = root.bodyTab.acc.data[0];
